...
select item_purchased as product , ROUND(avg(review_rating)::numeric,2) as average_rating
from customer
group by product
...
--Q9) Are customers who are repeat buyers(more tahn 5 previous purchases) also likely to subscribe?
